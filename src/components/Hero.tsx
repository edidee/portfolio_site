...
export const Hero = () => {
  return (
    <header
      id="home"
      className="container mb-14 lg:mb-0 lg:h-screen w-full text-black md:text-white text-center"
    >
      <div className="w-10/12 md:w-8/12 mt-[100px] flex flex-col items-center justify-center mx-auto">
        ...
        <h1 className="text-5xl md:text-[115px] md:mt-[2rem] text-black md:text-white font-bold">
